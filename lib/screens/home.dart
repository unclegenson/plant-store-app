...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            searchBarMethod(size),
            tabBarMethod(),
            const SizedBox(
              height: 10,
            ),
            showFlowers.isEmpty
                ? nothingToShowContainer(size)
                : upperListViewBuilderMethod(size),
            Row(
            ...
            lowerListViewBuilder(size, context)
          ],
        ),
      ),
    );
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Text(
                                  DataBase.data[index]!['price'].toString(),
  ...
  SizedBox upperListViewBuilderMethod(Size size) {
    return SizedBox(
      height: 210,
      width: size.width * 1,
      child: ListView.builder(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      showFlowers[index]['price'].toString(),
                    ...
                    onPressed: () {
                      setState(() {
                        showFlowers[index]['is liked']
                            ? showFlowers[index]['is liked'] = false
                            : showFlowers[index]['is liked'] = true;
                      });
                    },
                    icon: Icon(
                      showFlowers[index]['is liked']
  ...
  Padding nothingToShowContainer(Size size) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Container(
        height: 194,
  ...
  DefaultTabController tabBarMethod() {
